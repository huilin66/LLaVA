...
def df2pdf(df, pdf_path, image_path):
    ...
    pdfmetrics.registerFont(TTFont("TimesNewRoman", r"/usr/share/fonts/truetype/msttcorefonts/times.ttf"))
    pdfmetrics.registerFont(TTFont("TimesNewRoman-Bold", r"/usr/share/fonts/truetype/msttcorefonts/timesbd.ttf"))
...
if __name__ == '__main__':
    pass
    df = pd.read_csv(r'test.csv', header=0, index_col=0, names=['property', 'value'])
    df2pdf(df, 'report.pdf', r'examples/1.jpg')
